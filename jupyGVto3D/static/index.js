...
// dynamically.
__webpack_require__.p = document.querySelector('body').getAttribute('data-base-url') + 'nbextensions/jupyGVto3D/';
...
module.exports = {"name":"jupyGVto3D","version":"0.1.0","description":"jupy widgets to explore links between dna and 3d structure","author":"Paul Shannon","main":"lib/index.js","repository":{"type":"git","url":"https://github.com/paul-shannon/jupyGVto3D.git"},"keywords":["jupyter","widgets","ipython","ipywidgets"],"files":["lib/**/*.js","dist/*.js"],"scripts":{"clean":"rimraf dist/","prepublish":"webpack","test":"echo \"Error: no test specified\" && exit 1"},"devDependencies":{"webpack":"^3.5.5","rimraf":"^2.6.1"},"dependencies":{"@jupyter-widgets/base":"^1.0.0","lodash":"^4.17.4"}}
